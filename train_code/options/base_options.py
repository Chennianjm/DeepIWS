...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--learn_residual', default=False, action='store_true', help='learn the residual to the input')
		...
		self.parser.add_argument('--single_image', type=str, default='both', help='single channel A or B or both')
